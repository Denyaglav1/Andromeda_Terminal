...
export function DSSelect({
  ...
  const borderColor = disabled ? 'var(--ds-border-primary)' : error ? 'var(--ds-red-6)' : success ? 'var(--ds-green-6)' : isOpen ? 'var(--ds-blue-6)' : triggerHovered ? 'rgba(90,140,255,0.5)' : 'var(--ds-border-primary)';
                ...
                {group.items.map(option => (
                  <button
                    ...
                    style={{
                      ...
                      background: option.value === value ? 'rgba(90,140,255,0.3)' : hoveredValue === option.value ? 'rgba(90,140,255,0.15)' : 'none',
  ...
  return (
    <button
      ...
      style={{
        ...
        background: selected ? 'rgba(90,140,255,0.3)' : hovered ? 'rgba(90,140,255,0.15)' : 'none',
