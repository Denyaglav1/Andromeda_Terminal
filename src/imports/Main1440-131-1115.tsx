import svgPaths from "./svg-upf7oqxnsf";
      ...
      <div className="absolute inset-[-2.74%_0_-2.69%_-0.33%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 76.2476 24.4376">
          <g id="Group 336587">
            ...
            <path d={svgPaths.p3a7c8300} fill="url(#paint0_linear_131_12686)" id="Vector 6" />
            <path d={svgPaths.p208e6ee0} id="Vector 1" stroke="var(--stroke-0, #EA3943)" />
            <path d={svgPaths.p3bc025f0} fill="url(#paint1_linear_131_12686)" id="Vector 4" />
            <path d={svgPaths.p3ea48c00} id="Vector 2" stroke="var(--stroke-0, #1FC989)" />
            <path d={svgPaths.p386d0f00} fill="url(#paint2_linear_131_12686)" id="Vector 5" />
            <g id="Group 1">
          ...
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_131_12686" x1="71.4976" x2="71.4976" y1="8.23413" y2="13.1742">
              <stop stopColor="#EA3943" stopOpacity="0" />
              <stop offset="1" stopColor="#EA3943" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_131_12686" x1="22.2476" x2="22.2476" y1="8.61499" y2="23.8151">
              <stop stopColor="#EA3943" stopOpacity="0" />
              <stop offset="1" stopColor="#EA3943" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_131_12686" x1="56.7476" x2="56.7476" y1="0.634521" y2="8.61458">
      ...
      <div className="absolute inset-[-2.74%_0_-2.69%_-0.33%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 76.2476 24.4376">
          <g id="Group 336587">
            ...
            <path d={svgPaths.p208e6ee0} id="Vector 1" stroke="var(--stroke-0, #EA3943)" />
            <path d={svgPaths.p3bc025f0} fill="url(#paint0_linear_131_12451)" id="Vector 4" />
            <path d={svgPaths.p3fcd1900} id="Vector 2" stroke="var(--stroke-0, #1FC989)" />
            <path d={svgPaths.p5f23700} fill="url(#paint1_linear_131_12451)" id="Vector 5" />
            <g id="Group 1">
          ...
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_131_12451" x1="22.2476" x2="22.2476" y1="8.61499" y2="23.8151">
              <stop stopColor="#EA3943" stopOpacity="0" />
              <stop offset="1" stopColor="#EA3943" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_131_12451" x1="56.7476" x2="56.7476" y1="0.634521" y2="8.61458">
              <stop stopColor="#1FC989" />
              <stop offset="1" stopColor="#1FC989" stopOpacity="0" />
            </linearGradient>
          </defs>
...
function Frame125() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 text-[#c4c7c9] w-full">
      <div className="flex flex-col justify-center relative shrink-0 w-[561px]" style={{ fontFeatureSettings: "'lnum', 'tnum'" }}>
        <ul>
          <li className="list-disc ms-[21px] whitespace-pre-wrap">
            <span className="leading-[20px]">{`Глобальные рынки вчера закрылись в плюсе. Американский рынок (S&P 500 +0,9%) вырос. Акции техсектора (NASDAQ 100 +1,3%) Были среди лидеров. `}</span>
          </li>
        </ul>
      </div>
      <div className="flex flex-col justify-center min-w-full relative shrink-0 w-[min-content]" style={{ fontFeatureSettings: "'lnum', 'tnum'" }}>
        <ul>
          <li className="list-disc ms-[21px] whitespace-pre-wrap">
            <span className="leading-[20px]">{`Инвесткомпания CapVest близка к покупке  германской компании за 10 млрд. `}</span>
          </li>
        </ul>
      </div>
    </div>
...
function Frame120() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="content-stretch flex flex-col font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-start leading-[0] not-italic pl-[93px] relative text-[14px] w-full">
        <div className="flex flex-col justify-center relative shrink-0 text-[#e0e1e2] w-[551px]" style={{ fontFeatureSettings: "'lnum', 'tnum'" }}>
...
function Frame127() {
  return (
    <div className="h-[20px] relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pl-[95px] relative size-full">
          <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#e0e1e2] text-[12px] whitespace-nowrap">
            <p className="leading-[16px]">Связанные новости</p>
          </div>
        </div>
      </div>
    </div>
...
function Group6() {
  return (
    <div className="absolute inset-[11.7%_12.3%_11.7%_12.7%]" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.59982 9.80426">
        <g id="Group">
          <path d={svgPaths.p2ca584c0} fill="var(--fill-0, #9A8CFF)" id="Vector" />
          <g id="Vector_2">
            <path d={svgPaths.p78c6780} fill="var(--fill-0, #F87D37)" />
            <path d={svgPaths.p241ee600} fill="var(--fill-0, #F87D37)" />
          </g>
        </g>
      </svg>
    </div>
...
function Tags4() {
  return (
    <div className="content-stretch flex gap-[9.6px] items-center relative shrink-0 w-[16px]" data-name="tags">
      <div className="bg-[rgba(154,140,255,0.3)] relative rounded-[20px] shrink-0 size-[16px]" data-name="type">
        <div className="absolute left-[2.4px] overflow-clip size-[12.8px] top-[1.6px]" data-name="fi_4058839">
          <Group6 />
        </div>
      </div>
    </div>
...
function Group7() {
  return (
    <div className="absolute inset-[11.11%_16.69%_11.11%_16.67%]" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.6622 12.4444">
        <g id="Group">
          <path d={svgPaths.p36a62c00} fill="var(--fill-0, #677C9C)" id="Vector" />
          <path d={svgPaths.p280fd400} fill="var(--fill-0, #677C9C)" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function Icons3() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="icons">
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="sources">
        <Group7 />
      </div>
    </div>
  );
...
function Tags5() {
  return (
    <div className="content-stretch flex gap-[9.6px] items-center relative shrink-0 w-[16px]" data-name="tags">
      <div className="bg-[rgba(69,211,206,0.3)] relative rounded-[20px] shrink-0 size-[16px]" data-name="type">
        <div className="absolute left-[1.6px] overflow-clip size-[12.8px] top-[1.6px]" data-name="podcast.16">
          <div className="absolute inset-[12.5%_23.19%_12.5%_21.88%]" data-name="Vector">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.032 9.6">
              <g id="Vector">
                <path d={svgPaths.p11f5cd00} fill="var(--fill-0, #8FE5E2)" />
                <path d={svgPaths.p14dbd700} fill="var(--fill-0, #8FE5E2)" />
              </g>
            </svg>
          </div>
        </div>
...
function Group8() {
  return (
    <div className="absolute inset-[11.09%_15.42%_11.12%_13.85%]" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.3161 12.446">
        <g id="Group">
          <path clipRule="evenodd" d={svgPaths.p1bea9d80} fill="var(--fill-0, #677C9C)" fillRule="evenodd" id="Oval 12" />
        </g>
      </svg>
    </div>
  );
...
function Tags6() {
  return (
    <div className="content-stretch flex gap-[9.6px] items-center relative shrink-0 w-[16px]" data-name="tags">
      <div className="bg-[rgba(248,125,55,0.3)] relative rounded-[20px] shrink-0 size-[16px]" data-name="type">
        <div className="absolute left-[1.6px] overflow-clip size-[12.8px] top-[1.6px]" data-name="important.16">
          <div className="absolute bottom-[12.5%] left-1/4 right-[24.79%] top-[12.5%]" data-name="path">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6.42752 9.60055">
              <path d={svgPaths.p27e2500} fill="var(--fill-0, #FBB187)" id="path" />
            </svg>
          </div>
        </div>
      </div>
...
function Group9() {
  return (
    <div className="absolute inset-[16.67%_11.1%_11.14%_11.11%]" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.4461 11.5515">
        <g id="Group">
          <path clipRule="evenodd" d={svgPaths.p34a20900} fill="var(--fill-0, #677C9C)" fillRule="evenodd" id="path" />
        </g>
      </svg>
    </div>
  );
...
function Frame91() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pl-[63px] relative w-full">
          <Arrow2 />
          <When6 />
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[20px] justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[#677c9c] text-[12px] text-ellipsis w-[494px] whitespace-nowrap" style={{ fontFeatureSettings: "'lnum', 'tnum'" }}>
...
function Frame103() {
  return (
    <div className="content-stretch flex gap-[8px] items-center pl-[63px] relative shrink-0">
      <Arrow4 />
      <When8 />
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[20px] justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[#677c9c] text-[12px] text-ellipsis w-[494px] whitespace-nowrap" style={{ fontFeatureSettings: "'lnum', 'tnum'" }}>
        <p className="leading-[16px] overflow-hidden">Рынок акций РФ попытается подрости в понедельник</p>
...
function News3() {
  return (
    <div className="relative shrink-0 w-full" data-name="News">
      <div aria-hidden="true" className="absolute border-[#131722] border-b-2 border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[12px] items-start justify-center pb-[12px] pt-[8px] px-[12px] relative w-full">
          <Frame124 />
          <Frame106 />
        </div>
      </div>
...
function Body4() {
  return (
    <div className="bg-[#1e2637] content-stretch flex flex-col items-start relative shrink-0 w-full z-[12]" data-name="body">
      <News3 />
    </div>
  );
}
