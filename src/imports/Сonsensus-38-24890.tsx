import svgPaths from "./svg-92fun76ie8";
import { imgGroup } from "./svg-k9cf4";
...
function ButtonsgroupRequest() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="buttonsgroup+request">
      ...
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#c4c7c9] text-[12px]" style={{ fontFeatureSettings: "\'lnum\', \'tnum\'" }}>
...
function Frame15() {
  return (
    <div className="bg-[#1e313e] h-[12px] relative rounded-[4px] shrink-0 w-[19px]">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center px-[4px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#c4c7c9] text-[10px] text-center w-full">
