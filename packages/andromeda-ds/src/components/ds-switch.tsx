      ...
      >
        <button
          ...
          style={{
            ...
            height: s.trackH,
            padding: s.padding,
            backgroundColor: checked ? (hovered ? 'var(--ds-blue-5)' : 'var(--ds-blue-6)') : 'transparent',
            border: checked ? '1px solid transparent' : `1px solid ${hovered ? 'rgba(90,140,255,0.5)' : 'var(--ds-switch-off-border)'}`,
