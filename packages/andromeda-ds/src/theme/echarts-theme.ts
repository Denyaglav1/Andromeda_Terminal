...
export const andromedaEChartsTheme = {
  ...
  color: [
    COLORS.blue6, COLORS.green6, COLORS.red6, COLORS.orange6,
    COLORS.yellow6, COLORS.purple6, COLORS.turquoise6,
  ],
  textStyle: {
  ...
  title: {
    textStyle: { color: COLORS.textPrimary, fontSize: 14, fontWeight: 500 },
    subtextStyle: { color: COLORS.textSubtle, fontSize: 12 },
  },
  line: { itemStyle: { borderWidth: 0 }, lineStyle: { width: 1.5 }, symbolSize: 0, symbol: 'circle', smooth: false },
  ...
  valueAxis: {
    ...
    axisTick: { show: false },
    axisLabel: { color: COLORS.textSubtle, fontSize: 11 },
    splitLine: { show: true, lineStyle: { color: COLORS.dark4, type: 'dashed', opacity: 0.5 } },
  },
  legend: { textStyle: { color: COLORS.textSecondary, fontSize: 12 }, icon: 'roundRect', itemWidth: 12, itemHeight: 8, itemGap: 16 },
  tooltip: {
